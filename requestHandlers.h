...
int MessageType3Handler(MessageType1 * messageType1, State * state, void * outMessage);
int MessageType6Handler(MessageType1 * messageType1, State * state, void * outMessage);
